...
export default function HeatingPage({ lead }) {
  return <CategoryHub lead={lead} slug="heating" />
}
...
export async function getStaticProps({ params }) {
  ...
  if (!categoryServices(res.props.lead, 'heating')) return { notFound: true, revalidate: 300 }
  return res
}
